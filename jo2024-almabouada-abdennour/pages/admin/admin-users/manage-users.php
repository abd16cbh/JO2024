...
<body>
    <header>
        <nav>
            <!-- Menu vers les pages sports, events, results... -->
            <ul class="menu">
    ...
    <main>
        ...
        <div class="action-buttons">
            <button onclick="openAddUtilisateurForm()">Ajouter un Utilisateur</button>
            <!-- Autres boutons... -->
        </div>
...
// (fonctionne à condition d’avoir activé l’option en local)
    ...
    <script>
        ...
        function deleteUtilisateurConfirmation(id_utilisateur) {
            // Ajoutez ici le code pour afficher une fenêtre de confirmation pour supprimer un utilisateur
            if (confirm("Êtes-vous sûr de vouloir supprimer cet utilisateur?")) {
                // Ajoutez ici le code pour la suppression de l'utilisateur
                // alert(id_utilisateur);
